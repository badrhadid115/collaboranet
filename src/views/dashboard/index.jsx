      ...
      <div className="d-flex friendlist-box align-items-center justify-content-center m-b-20">
        ...
        <div className="flex-grow-1 ms-3">
          ...
          <span className="float-end d-flex  align-items-center">
            <i className="fa fa-caret-up f-22 m-r-10 text-c-green" /> 3784
          </span>
        </div>
      </div>
      <div className="d-flex friendlist-box align-items-center justify-content-center m-b-20">
          ...
          <Card.Body>
            <div className="row align-items-center justify-content-center">
              ...
              <div className="col-auto">
                <label htmlFor="event-progress" className="label theme-bg2 text-white f-14 f-w-400 float-end">
                  34%
                </label>
              </div>
            </div>
            <h2 id="event-progress" className="mt-2 f-w-300">
